...
lineaccesstoken = 'iGMSokMy1DS7Pmcrb5S/jbsBZow8KLAqwzlw1CUspE5CkV2eecuiXFuPaVS7BtpP7Lgff9xUuheSLZSGwlyJ+Ozp+GVAexLpNw+lkBq1LZBw7yFoDnseiuaxrXh/Lsw198vl1zHGEoI0N9Qt0WNVEQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="กินเเล้วแต่กินอีกก็ได้")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ชอบเรามั้ย") :
            replyObj = TextSendMessage(text="ชอบจ้า")
            line_bot_api.reply_message(rtoken, replyObj)
        else :    
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/71f85ee1-24e3-4950-aee7-2f42be64e76b"
